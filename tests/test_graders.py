...
class TestClauseIdentification:
    def test_perfect_score(self):
        ...
        assert grade_clause_identification(identified, gt) == pytest.approx(1 - 1e-4, abs=1e-4)
    ...
    def test_all_wrong(self):
        ...
        assert grade_clause_identification(identified, gt) == pytest.approx(1e-4, abs=1e-4)
    ...
    def test_empty_ground_truth(self):
        assert grade_clause_identification([], {}) == pytest.approx(1e-4, abs=1e-4)

    def test_empty_identifications(self):
        gt = {"0": "position"}
        assert grade_clause_identification([], gt) == pytest.approx(1e-4, abs=1e-4)
...
class TestRiskFlagging:
    def test_perfect_score(self):
        ...
        assert score == pytest.approx(1 - 1e-4, abs=0.01)
    ...
    def test_no_risks_flagged(self):
        ...
        assert score == pytest.approx(1e-4, abs=1e-4)
    ...
    def test_empty_ground_truth(self):
        assert grade_risk_flagging([], [], []) == pytest.approx(1e-4, abs=1e-4)
